  ...
  <div class="card-header">
      ...
      <div class="float-right">
        @if (permissionCheck('add'))
          <a href="{{ url('products/outlet/add') }}" class="btn bg-gradient-primary btn-sm">Add</a>
        @endif
      </div>
  </div>
  @if ($lists->isEmpty())
            ...
            <tr>
              ...
              <td>
                <div class="btn-group btn-block">
                  @if (permissionCheck('edit')) <a href="{{ url('products/outlet/edit/'.$value->uuid) }}" class="btn btn-success btn-sm">Edit</a> @endif
                  @if (permissionCheck('delete')) <a href="{{ url('products/outlet/delete/'.$value->uuid) }}" onclick="return confirm('Anda yakin menghapus data ini?')" class="btn btn-danger btn-sm">Delete</a> @endif
                </div>
              </td>
            </tr>
          @endforeach
