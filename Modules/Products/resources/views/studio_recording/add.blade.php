  ...
  <form action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body row">
      <div class="col-sm-12">
        ...
        <div class="form-group">
          <label for="studiorecording_name">Studio Recording Name</label>
          <input type="text" class="form-control" id="studiorecording_name" name="studiorecording_name" placeholder="Studio Recording Name" value="{{ old('studiorecording_name') }}" required>
        </div>
        <div class="form-group">
    ...
    <div class="card-footer">
      ...
      <a href="{{ url('products/studiorecording') }}" onclick="return confirm('Anda yakin mau kembali?')" class="btn btn-success">Kembali</a>
    </div>
  </form>
</div>
