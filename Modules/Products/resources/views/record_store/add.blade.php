    ...
    <div class="card-body row">
      <div class="col-sm-12">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="recordstore_name" name="recordstore_name" placeholder="Record Store Name" value="{{ old('recordstore_name') }}" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select class="select2bs4" multiple="multiple" data-placeholder="Pick music format" name="musicformat[]" style="width: 100%;">
            @foreach ($musicformat as $item)
                <option value="{{ $item->uuid }}" @selected(old('musicformat') == $item->uuid)>
                    {{ $item->name }}
                </option>
            @endForeach
          </select>
